  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="row">
          <ImageLink label="VocabQuiz" quizUrl="http://www.gameswithwords.org/VocabQuiz/" logo={logo} quizInto="How many words do you know" />
          <ImageLink label="VerbConor" quizUrl="http://www.gameswithwords.org/VerbCorner/" logo={logo} quizInto="Crowdsourcing language, meaning & thought" />
