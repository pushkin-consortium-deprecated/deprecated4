          ...
          <Row>
            <Col xs={12}>
              <div className={s.blurb} >
                ...
                <hr />
                <p className={s.sub} style={{marginLeft:'20px', marginRight:'20px'}} ><a className={s.title} href="/exparchive.html">VerbCorner</a><br />Help us crowdsource the structure of language, meaning, and thought</p>
                <hr />
