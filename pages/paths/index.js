    ...
    <div className={s.white}>
      ...
      <Row className="display">
        <Col sm={12} lg={6} className={s.gif + ' ' + s.border}>
          <Link href="/projects"><Image src={require("../../gif/res.gif")} style={{marginTop: '25px'}} responsive className={s.gif}/></Link>
        ...
        <Col sm={12} lg={6} className={s.gif + ' ' + s.margin}>
          <Link to="/quizzes"><Image src={require("../../gif/par.gif")} style={{marginTop: '25px'}} responsive className={s.gif}/></Link>
