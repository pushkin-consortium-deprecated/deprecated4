...
export const routes = (<Route path="/" component={Container}>
  ...
  */}
  <Route path="/quizzes" component={Quizzes} />
  {/* not how we're ensuring that non mobile compatabile quizzes don't open on mobile devices or tablets */}
  <Route path="/quizzes/listener-quiz" component={listenerQuiz} onEnter={ensureDesktop} />
