...
const config = {
  title: 'Website',        // Your website title
  url: 'URL',          // Your website URL
  project: 'PROJECT',      // Firebase project. See README.md -> How to Deploy
  trackingID: 'ID',                 // Google Analytics Site's ID
};
...
tasks.set('publish', () => {
  ...
  return run('build').then(() => new Promise((resolve, reject) => {
    ...
    const uploader = client.uploadDir({
      localDir: 'public',
      deleteRemoved: true,
      s3Params: { Bucket: 'BUCKET' }, // TODO: Update deployment URL
    });
